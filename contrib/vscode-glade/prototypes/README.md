...
- project root, active Glade org, active data environment, schema, and proof
  state at the top;
- a setup rail for project, local org, Salesforce target, data, and proof;
- one command strip for inspect, seed, reset, export, SOQL, anonymous Apex, and
  local proof;
- a connection and data movement area for target-org checks, schema import,
