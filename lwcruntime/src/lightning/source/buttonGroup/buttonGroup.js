...
import _tmpl from "./buttonGroup.html.js";
class LightningButtonGroup extends LightningElement {
  constructor() {
    super();
...
_registerDecorators(LightningButtonGroup, {
  fields: ["privateButtons"]
});
const __lwc_component_class_internal = _registerComponent(LightningButtonGroup, {
  tmpl: _tmpl,
  sel: "lightning-button-group",
  apiVersion: 63
});
