...
Start with parse, check, test, SOQL, DML, triggers, and SObjects.
Those are the main local Apex paths.
Then check the detailed source for limits before moving a team workflow.
