...
> Source: `glade-tools/README.md`.

# glade-tools: Glade Tools
...
[`docs/CAPABILITY_WORK_QUEUE.md`](/maintainer/tools/capability-work-queue). Checked
...
[`docs/visualforce-oracle.md`](/maintainer/tools/visualforce-oracle), including the
`oaer-probe-max` capture path and phase filters.

LWC native API parity is tracked in
[`docs/generated/LWC_NATIVE_API_PARITY.md`](https://github.com/glade-sh/glade-tools/blob/main/docs/generated/LWC_NATIVE_API_PARITY.md).
...
See [`docs/plugin-registry.md`](/maintainer/tools/plugin-registry) for the private source
