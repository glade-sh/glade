...
| Exact hosted Lightning Experience behavior | The local LWC shell does not promise Salesforce-hosted app chrome, permissions, console APIs, full UI API, all `lightning-*` base components, exact SLDS fidelity, or every Lightning Out edge. |
