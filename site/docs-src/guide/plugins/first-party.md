...
`@glade/compat` is for compatibility fixture work, support reports, and compatibility
...
The compat plugin owns compatibility fixtures, support reports, and compatibility
scanners.
