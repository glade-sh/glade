...
repository and is generated by `glade-tools`.

## Current reports

`glade` ships the framework and local tool. `glade-tools` owns the maintenance
commands that regenerate repository reports.
