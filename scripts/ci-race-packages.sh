...
if len(packages) != 61 or len(set(packages)) != 61 or any(not value.startswith(module + "/") for value in packages):
    raise SystemExit("race classifier requires 61 unique in-module packages")
