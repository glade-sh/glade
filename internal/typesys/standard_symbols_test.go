...
func TestStandardPlatformSymbolsDatabaseSyncAccessorsUseSalesforceReturns(t *testing.T) {
	symbols := StandardPlatformSymbols()
	...
	requireStandardMethodReturn(t, deletedRecord, "getDeletedDate", []string{}, "Datetime", false)
