...
var standardPlatformSymbolSpecs = []StandardSymbolSpec{
	...
	{Name: "Auth.RegistrationHandler", Kind: apexast.DeclarationInterface, Methods: []StandardMethodSpec{{Name: "createUser", ReturnType: "User", Parameters: []string{"Id", "Auth.UserData"}}, {Name: "updateUser", ReturnType: "void", Parameters: []string{"Id", "Id", "Auth.UserData"}}}},
	...
	{Name: "Database.DeletedRecord", Constructors: [][]string{{}}, Methods: []StandardMethodSpec{{Name: "getId", ReturnType: "Id"}, {Name: "getDeletedDate", ReturnType: "Date"}}},
	{Name: "Database.GetDeletedResult", Constructors: [][]string{{}}, Methods: []StandardMethodSpec{{Name: "getDeletedRecords", ReturnType: "List<Database.DeletedRecord>"}, {Name: "getEarliestDateAvailable", ReturnType: "Date"}, {Name: "getLatestDateCovered", ReturnType: "Date"}}},
	{Name: "Database.GetUpdatedResult", Constructors: [][]string{{}}, Methods: []StandardMethodSpec{{Name: "getIds", ReturnType: "List<Id>"}, {Name: "getLatestDateCovered", ReturnType: "Date"}}},
...
var standardPlatformSymbolOverlays = []StandardSymbolSpec{
	...
	{Name: "Database", Methods: []StandardMethodSpec{
		...
		{Name: "convertLead", ReturnType: "Database.LeadConvertResult", Parameters: []string{"Database.LeadConvert", "Database.DMLOptions"}, Static: true},
		{Name: "convertLead", ReturnType: "List<Database.LeadConvertResult>", Parameters: []string{"List<Database.LeadConvert>", "Database.DMLOptions"}, Static: true},
		{Name: "deleteAsync", ReturnType: "List<Database.DeleteResult>", Parameters: []string{"List<Object>"}, Static: true},
		...
		{Name: "deleteAsync", ReturnType: "Database.DeleteResult", Parameters: []string{"Object", "DataSource.AsyncDeleteCallback"}, Static: true},
		...
		{Name: "insertAsync", ReturnType: "List<Database.SaveResult>", Parameters: []string{"List<Object>"}, Static: true},
		...
		{Name: "insertAsync", ReturnType: "Database.SaveResult", Parameters: []string{"Object", "DataSource.AsyncSaveCallback"}, Static: true},
		...
		{Name: "updateAsync", ReturnType: "List<Database.SaveResult>", Parameters: []string{"List<Object>"}, Static: true},
		...
		{Name: "updateAsync", ReturnType: "Database.SaveResult", Parameters: []string{"Object", "DataSource.AsyncSaveCallback"}, Static: true},
