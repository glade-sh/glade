...
var standardPlatformSymbolSpecs = []StandardSymbolSpec{
	...
	{Name: "Test", Methods: []StandardMethodSpec{{Name: "setCurrentPage", ReturnType: "void", Parameters: []string{"PageReference"}, Static: true}, {Name: "setCurrentPageReference", ReturnType: "void", Parameters: []string{"PageReference"}, Static: true}}},
