...
var standardPlatformSymbolSpecs = []StandardSymbolSpec{
	{Name: "AccessLevel", Kind: apexast.DeclarationEnum, Methods: []StandardMethodSpec{{Name: "withPermissionSetId", ReturnType: "AccessLevel", Parameters: []string{"String"}, Static: true}}},
	...
	{Name: "BusinessHours", Methods: []StandardMethodSpec{
		{Name: "add", ReturnType: "Datetime", Parameters: []string{"String", "Datetime", "Long"}, Static: true},
		{Name: "addGmt", ReturnType: "Datetime", Parameters: []string{"String", "Datetime", "Long"}, Static: true},
		{Name: "nextStartDate", ReturnType: "Datetime", Parameters: []string{"String", "Datetime"}, Static: true},
	}},
	...
	{Name: "Messaging.InboundEmail", Properties: []StandardPropertySpec{{Name: "authenticationResults", Type: "List<Messaging.InboundEmail.AuthenticationResult>"}, {Name: "binaryAttachments", Type: "List<Messaging.InboundEmail.BinaryAttachment>"}, {Name: "ccAddresses", Type: "List<String>"}, {Name: "fromAddress", Type: "String"}, {Name: "fromName", Type: "String"}, {Name: "headers", Type: "List<Messaging.InboundEmail.Header>"}, {Name: "htmlBody", Type: "String"}, {Name: "htmlBodyIsTruncated", Type: "Boolean"}, {Name: "inReplyTo", Type: "String"}, {Name: "messageId", Type: "String"}, {Name: "plainTextBody", Type: "String"}, {Name: "plainTextBodyIsTruncated", Type: "Boolean"}, {Name: "references", Type: "String"}, {Name: "replyTo", Type: "String"}, {Name: "subject", Type: "String"}, {Name: "textAttachments", Type: "List<Messaging.InboundEmail.TextAttachment>"}, {Name: "toAddresses", Type: "List<String>"}}},
	...
	{Name: "Test", Methods: []StandardMethodSpec{{Name: "setCurrentPage", ReturnType: "void", Parameters: []string{"PageReference"}, Static: true}, {Name: "setCurrentPageReference", ReturnType: "void", Parameters: []string{"PageReference"}, Static: true}, {Name: "setFixedSearchResults", ReturnType: "void", Parameters: []string{"List<Id>"}, Static: true}}},
