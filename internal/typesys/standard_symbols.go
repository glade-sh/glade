...
var standardPlatformSymbolSpecs = []StandardSymbolSpec{
	...
	{Name: "Schema.DescribeFieldResult", Methods: []StandardMethodSpec{{Name: "getName", ReturnType: "String"}, {Name: "getType", ReturnType: "Schema.DisplayType"}, {Name: "getSOAPType", ReturnType: "Schema.SoapType"}, {Name: "getSoapType", ReturnType: "Schema.SoapType"}, {Name: "getSObjectType", ReturnType: "Schema.SObjectType"}, {Name: "getCompoundFieldName", ReturnType: "String"}, {Name: "isAccessible", ReturnType: "Boolean"}, {Name: "isCreateable", ReturnType: "Boolean"}, {Name: "isUpdateable", ReturnType: "Boolean"}, {Name: "isCalculated", ReturnType: "Boolean"}}, Properties: []StandardPropertySpec{{Name: "compoundFieldName", Type: "String"}}},
	{Name: "Schema.DisplayType", Kind: apexast.DeclarationEnum, Properties: []StandardPropertySpec{{Name: "BOOLEAN", Type: "Schema.DisplayType", Static: true}, {Name: "CURRENCY", Type: "Schema.DisplayType", Static: true}, {Name: "DATE", Type: "Schema.DisplayType", Static: true}, {Name: "DATETIME", Type: "Schema.DisplayType", Static: true}, {Name: "DOUBLE", Type: "Schema.DisplayType", Static: true}, {Name: "EMAIL", Type: "Schema.DisplayType", Static: true}, {Name: "ENCRYPTEDSTRING", Type: "Schema.DisplayType", Static: true}, {Name: "ID", Type: "Schema.DisplayType", Static: true}, {Name: "INTEGER", Type: "Schema.DisplayType", Static: true}, {Name: "MULTIPICKLIST", Type: "Schema.DisplayType", Static: true}, {Name: "PERCENT", Type: "Schema.DisplayType", Static: true}, {Name: "PHONE", Type: "Schema.DisplayType", Static: true}, {Name: "PICKLIST", Type: "Schema.DisplayType", Static: true}, {Name: "REFERENCE", Type: "Schema.DisplayType", Static: true}, {Name: "STRING", Type: "Schema.DisplayType", Static: true}, {Name: "TEXTAREA", Type: "Schema.DisplayType", Static: true}, {Name: "URL", Type: "Schema.DisplayType", Static: true}}},
	{Name: "SObjectDescribeOptions", Kind: apexast.DeclarationEnum, Properties: []StandardPropertySpec{{Name: "DEFERRED", Type: "SObjectDescribeOptions", Static: true}, {Name: "FULL", Type: "SObjectDescribeOptions", Static: true}}},
	...
	{Name: "Database.Error", Methods: []StandardMethodSpec{{Name: "getFields", ReturnType: "List<String>"}, {Name: "getMessage", ReturnType: "String"}, {Name: "getStatusCode", ReturnType: "StatusCode"}}},
