...
var standardPlatformSymbolSpecs = []StandardSymbolSpec{
	...
	{Name: "Database", Methods: []StandardMethodSpec{
		...
		{Name: "emptyRecycleBin", ReturnType: "Database.EmptyRecycleBinResult", Parameters: []string{"SObject", "Boolean"}, Static: true},
		{Name: "emptyRecycleBin", ReturnType: "Database.EmptyRecycleBinResult", Parameters: []string{"Id"}, Static: true},
		{Name: "emptyRecycleBin", ReturnType: "Database.EmptyRecycleBinResult", Parameters: []string{"Id", "Boolean"}, Static: true},
		{Name: "emptyRecycleBin", ReturnType: "List<Database.EmptyRecycleBinResult>", Parameters: []string{"List<SObject>"}, Static: true},
		{Name: "emptyRecycleBin", ReturnType: "List<Database.EmptyRecycleBinResult>", Parameters: []string{"List<SObject>", "Boolean"}, Static: true},
		{Name: "emptyRecycleBin", ReturnType: "List<Database.EmptyRecycleBinResult>", Parameters: []string{"List<Id>"}, Static: true},
		{Name: "emptyRecycleBin", ReturnType: "List<Database.EmptyRecycleBinResult>", Parameters: []string{"List<Id>", "Boolean"}, Static: true},
		{Name: "lock", ReturnType: "Database.LockResult", Parameters: []string{"Id"}, Static: true},
		{Name: "lock", ReturnType: "Database.LockResult", Parameters: []string{"Id", "Boolean"}, Static: true},
		{Name: "lock", ReturnType: "List<Database.LockResult>", Parameters: []string{"List<Id>"}, Static: true},
		{Name: "lock", ReturnType: "List<Database.LockResult>", Parameters: []string{"List<Id>", "Boolean"}, Static: true},
		{Name: "lock", ReturnType: "Database.LockResult", Parameters: []string{"SObject"}, Static: true},
		{Name: "lock", ReturnType: "Database.LockResult", Parameters: []string{"SObject", "Boolean"}, Static: true},
		{Name: "lock", ReturnType: "List<Database.LockResult>", Parameters: []string{"List<SObject>"}, Static: true},
		{Name: "lock", ReturnType: "List<Database.LockResult>", Parameters: []string{"List<SObject>", "Boolean"}, Static: true},
		{Name: "unlock", ReturnType: "Database.UnlockResult", Parameters: []string{"Id"}, Static: true},
		{Name: "unlock", ReturnType: "Database.UnlockResult", Parameters: []string{"Id", "Boolean"}, Static: true},
		{Name: "unlock", ReturnType: "List<Database.UnlockResult>", Parameters: []string{"List<Id>"}, Static: true},
		{Name: "unlock", ReturnType: "List<Database.UnlockResult>", Parameters: []string{"List<Id>", "Boolean"}, Static: true},
		{Name: "unlock", ReturnType: "Database.UnlockResult", Parameters: []string{"SObject"}, Static: true},
		{Name: "unlock", ReturnType: "Database.UnlockResult", Parameters: []string{"SObject", "Boolean"}, Static: true},
		{Name: "unlock", ReturnType: "List<Database.UnlockResult>", Parameters: []string{"List<SObject>"}, Static: true},
		{Name: "unlock", ReturnType: "List<Database.UnlockResult>", Parameters: []string{"List<SObject>", "Boolean"}, Static: true},
		{Name: "insertImmediate", ReturnType: "Database.SaveResult", Parameters: []string{"SObject"}, Static: true},
		{Name: "insertImmediate", ReturnType: "Database.SaveResult", Parameters: []string{"SObject", "Boolean"}, Static: true},
		{Name: "insertImmediate", ReturnType: "Database.SaveResult", Parameters: []string{"SObject", "AccessLevel"}, Static: true},
		{Name: "insertImmediate", ReturnType: "Database.SaveResult", Parameters: []string{"SObject", "Boolean", "AccessLevel"}, Static: true},
		{Name: "insertImmediate", ReturnType: "List<Database.SaveResult>", Parameters: []string{"List<SObject>"}, Static: true},
		{Name: "insertImmediate", ReturnType: "List<Database.SaveResult>", Parameters: []string{"List<SObject>", "Boolean"}, Static: true},
		{Name: "insertImmediate", ReturnType: "List<Database.SaveResult>", Parameters: []string{"List<SObject>", "AccessLevel"}, Static: true},
		{Name: "insertImmediate", ReturnType: "List<Database.SaveResult>", Parameters: []string{"List<SObject>", "Boolean", "AccessLevel"}, Static: true},
		{Name: "updateImmediate", ReturnType: "Database.SaveResult", Parameters: []string{"SObject"}, Static: true},
		{Name: "updateImmediate", ReturnType: "Database.SaveResult", Parameters: []string{"SObject", "Boolean"}, Static: true},
		{Name: "updateImmediate", ReturnType: "Database.SaveResult", Parameters: []string{"SObject", "AccessLevel"}, Static: true},
		{Name: "updateImmediate", ReturnType: "Database.SaveResult", Parameters: []string{"SObject", "Boolean", "AccessLevel"}, Static: true},
		{Name: "updateImmediate", ReturnType: "List<Database.SaveResult>", Parameters: []string{"List<SObject>"}, Static: true},
		{Name: "updateImmediate", ReturnType: "List<Database.SaveResult>", Parameters: []string{"List<SObject>", "Boolean"}, Static: true},
		{Name: "updateImmediate", ReturnType: "List<Database.SaveResult>", Parameters: []string{"List<SObject>", "AccessLevel"}, Static: true},
		{Name: "updateImmediate", ReturnType: "List<Database.SaveResult>", Parameters: []string{"List<SObject>", "Boolean", "AccessLevel"}, Static: true},
		{Name: "deleteImmediate", ReturnType: "Database.DeleteResult", Parameters: []string{"SObject"}, Static: true},
		{Name: "deleteImmediate", ReturnType: "Database.DeleteResult", Parameters: []string{"SObject", "Boolean"}, Static: true},
		{Name: "deleteImmediate", ReturnType: "Database.DeleteResult", Parameters: []string{"SObject", "AccessLevel"}, Static: true},
		{Name: "deleteImmediate", ReturnType: "Database.DeleteResult", Parameters: []string{"SObject", "Boolean", "AccessLevel"}, Static: true},
		{Name: "deleteImmediate", ReturnType: "List<Database.DeleteResult>", Parameters: []string{"List<SObject>"}, Static: true},
		{Name: "deleteImmediate", ReturnType: "List<Database.DeleteResult>", Parameters: []string{"List<SObject>", "Boolean"}, Static: true},
		{Name: "deleteImmediate", ReturnType: "List<Database.DeleteResult>", Parameters: []string{"List<SObject>", "AccessLevel"}, Static: true},
		{Name: "deleteImmediate", ReturnType: "List<Database.DeleteResult>", Parameters: []string{"List<SObject>", "Boolean", "AccessLevel"}, Static: true},
	...
	{Name: "Map", Constructors: [][]string{{}, {"Map"}, {"List<SObject>"}}, Methods: []StandardMethodSpec{{Name: "containsValue", ReturnType: "Boolean", Parameters: []string{"Object"}}, {Name: "equals", ReturnType: "Boolean", Parameters: []string{"Map"}}, {Name: "remove", ReturnType: "Object", Parameters: []string{"Object"}}}},
	...
	{Name: "Database.LockResult", ReplaceConstructors: true},
	{Name: "Database.UnlockResult", ReplaceConstructors: true},
	...
	{Name: "Database.BatchableContextImpl", Constructors: [][]string{{}}, Methods: []StandardMethodSpec{{Name: "getChildJobId", ReturnType: "Id"}, {Name: "getJobId", ReturnType: "Id"}}},
	{Name: "Database.Cursor", Constructors: [][]string{{}}, Methods: []StandardMethodSpec{{Name: "getNumRecords", ReturnType: "Integer"}, {Name: "fetch", ReturnType: "List<SObject>", Parameters: []string{"Integer", "Integer"}}}},
	{Name: "Database.CursorFetchResult", Constructors: [][]string{{}}, Methods: []StandardMethodSpec{{Name: "getRecords", ReturnType: "List<SObject>"}, {Name: "getNextIndex", ReturnType: "Integer"}, {Name: "getNumDeletedRecords", ReturnType: "Integer"}, {Name: "isDone", ReturnType: "Boolean"}}},
	{Name: "Database.DeletedRecord", Constructors: [][]string{{}}, Methods: []StandardMethodSpec{{Name: "getId", ReturnType: "Id"}, {Name: "getDeletedDate", ReturnType: "Datetime"}}},
	{Name: "Database.GetDeletedResult", Constructors: [][]string{{}}, Methods: []StandardMethodSpec{{Name: "getDeletedRecords", ReturnType: "List<Database.DeletedRecord>"}, {Name: "getEarliestDateAvailable", ReturnType: "Datetime"}, {Name: "getLatestDateCovered", ReturnType: "Datetime"}}},
	{Name: "Database.GetUpdatedResult", Constructors: [][]string{{}}, Methods: []StandardMethodSpec{{Name: "getIds", ReturnType: "List<Id>"}, {Name: "getLatestDateCovered", ReturnType: "Datetime"}}},
