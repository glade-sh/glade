...
var standardPlatformSymbolSpecs = []StandardSymbolSpec{
	...
	{Name: "Database", Methods: []StandardMethodSpec{{Name: "setSavepoint", ReturnType: "Savepoint", Static: true}, {Name: "rollback", ReturnType: "void", Parameters: []string{"Savepoint"}, Static: true}, {Name: "getQueryLocator", ReturnType: "Database.QueryLocator", Parameters: []string{"String"}, Static: true}, {Name: "insert", ReturnType: "Database.SaveResult", Parameters: []string{"SObject"}, Static: true}, {Name: "insert", ReturnType: "Database.SaveResult", Parameters: []string{"SObject", "Boolean"}, Static: true}, {Name: "insert", ReturnType: "List<Database.SaveResult>", Parameters: []string{"List<SObject>"}, Static: true}, {Name: "insert", ReturnType: "List<Database.SaveResult>", Parameters: []string{"List<SObject>", "Boolean"}, Static: true}, {Name: "update", ReturnType: "Database.SaveResult", Parameters: []string{"SObject"}, Static: true}, {Name: "update", ReturnType: "Database.SaveResult", Parameters: []string{"SObject", "Boolean"}, Static: true}, {Name: "update", ReturnType: "List<Database.SaveResult>", Parameters: []string{"List<SObject>"}, Static: true}, {Name: "update", ReturnType: "List<Database.SaveResult>", Parameters: []string{"List<SObject>", "Boolean"}, Static: true}, {Name: "delete", ReturnType: "Database.DeleteResult", Parameters: []string{"SObject"}, Static: true}, {Name: "delete", ReturnType: "Database.DeleteResult", Parameters: []string{"SObject", "Boolean"}, Static: true}, {Name: "delete", ReturnType: "List<Database.DeleteResult>", Parameters: []string{"List<SObject>"}, Static: true}, {Name: "delete", ReturnType: "List<Database.DeleteResult>", Parameters: []string{"List<SObject>", "Boolean"}, Static: true}, {Name: "upsert", ReturnType: "Database.UpsertResult", Parameters: []string{"SObject"}, Static: true}, {Name: "upsert", ReturnType: "Database.UpsertResult", Parameters: []string{"SObject", "Boolean"}, Static: true}, {Name: "upsert", ReturnType: "Database.UpsertResult", Parameters: []string{"SObject", "Schema.SObjectField"}, Static: true}, {Name: "upsert", ReturnType: "Database.UpsertResult", Parameters: []string{"SObject", "Schema.SObjectField", "Boolean"}, Static: true}, {Name: "upsert", ReturnType: "List<Database.UpsertResult>", Parameters: []string{"List<SObject>"}, Static: true}, {Name: "upsert", ReturnType: "List<Database.UpsertResult>", Parameters: []string{"List<SObject>", "Boolean"}, Static: true}, {Name: "upsert", ReturnType: "List<Database.UpsertResult>", Parameters: []string{"List<SObject>", "Schema.SObjectField"}, Static: true}, {Name: "upsert", ReturnType: "List<Database.UpsertResult>", Parameters: []string{"List<SObject>", "Schema.SObjectField", "Boolean"}, Static: true}}},
