...
var standardPlatformSymbolSpecs = []StandardSymbolSpec{
	...
	{Name: "Database.DeleteFilter", Kind: apexast.DeclarationEnum, Properties: standardEnumProperties("Database.DeleteFilter", "DELETED_ROWS_ONLY", "NO_DELETED_ROWS", "NO_DELETED_SHARING_ROWS", "NO_FILTER")},
