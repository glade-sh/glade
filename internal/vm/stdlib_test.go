...
System.assertEquals('...ijklmn...', alphabet.abbreviate(12, 8));
...
System.assertEquals('...lmnopq...', 'abcdefghijklmnopqrstuvwxyz'.abbreviate(12, 11));
...
Boolean paddedTrue = Boolean.valueOf(' TRUE ');
Boolean falsy = boolean.valueOf('no');
Object boxedFalse = false;
Boolean objectFalse = Boolean.valueOf(boxedFalse);
...
System.assertEquals(false, paddedTrue);
System.assertEquals(false, falsy);
System.assertEquals(false, objectFalse);
