...
var canonicalBuiltinStaticCalls = func() map[string]string {
	names := []string{
		...
		"Answers.findSimilar", "Answers.setBestReply",
		...
		"ConnectApi.UserProfiles.getUserProfile", "ConnectApi.UserProfiles.getPhoto",
		...
		"Cache.Org.getCapacity", "Cache.Session.getCapacity", "Cache.Session.isAvailable",
		...
		"BusinessRule.DynamicRuleDebugService.getInputDataTableMapFromContextInstance",
		"BusinessRule.DynamicRuleDebugService.getRuleLibraryContents", "BusinessRule.DynamicRuleDebugService.getRulePayloads",
