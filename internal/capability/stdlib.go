...
var stdlibEntries = []StdlibEntry{
	{Area: "AccessLevel", API: "AccessLevel.withPermissionSetId(String)", Status: StatusUnsupported, Notes: "Permission-set-scoped user mode requires permission-set semantics and returns a stable UnsupportedFeature diagnostic locally."},
	...
	{Area: "Approval", API: "Approval.process(Approval.ProcessRequest)", Status: StatusUnsupported, Notes: "Approval execution requires org approval-process metadata and returns a stable UnsupportedFeature diagnostic locally."},
	{Area: "Approval", API: "Approval.process(Approval.ProcessRequest, Boolean)", Status: StatusUnsupported, Notes: "Approval execution with allOrNone requires org approval-process metadata and returns a stable UnsupportedFeature diagnostic locally."},
	{Area: "BusinessHours", API: "BusinessHours.add(String, Datetime, Long)", Status: StatusUnsupported, Notes: "Business-hours math requires BusinessHours and holiday metadata; no 24x7 default calendar is assumed."},
	{Area: "BusinessHours", API: "BusinessHours.addGmt(String, Datetime, Long)", Status: StatusUnsupported, Notes: "Business-hours GMT math requires BusinessHours and holiday metadata; no 24x7 default calendar is assumed."},
	{Area: "BusinessHours", API: "BusinessHours.diff(String, Datetime, Datetime)", Status: StatusUnsupported, Notes: "Business-hours interval calculation requires BusinessHours and holiday metadata; no 24x7 default calendar is assumed."},
	{Area: "BusinessHours", API: "BusinessHours.isWithin(String, Datetime)", Status: StatusUnsupported, Notes: "Business-hours membership calculation requires BusinessHours and holiday metadata; no 24x7 default calendar is assumed."},
	{Area: "BusinessHours", API: "BusinessHours.nextStartDate(String, Datetime)", Status: StatusUnsupported, Notes: "Business-hours reopening calculation requires BusinessHours and holiday metadata; no 24x7 default calendar is assumed."},
	...
	{Area: "Database", API: "Database.getAsyncDeleteResult", Status: StatusStub, Notes: "Returns materialized local DeleteResult values when the locator is local; unknown locators return a deterministic pending stub result."},
	{Area: "Database", API: "Database.getAsyncSaveResult", Status: StatusStub, Notes: "Returns materialized local SaveResult values when the locator is local; unknown locators return a deterministic pending stub result."},
	...
	{Area: "Database", API: "Database.getDeleted", Status: StatusStub, Notes: "Returns a deterministic empty deleted-record sync window stub; full org sync tracking is not modeled."},
	...
	{Area: "Database", API: "Database.getUpdated", Status: StatusStub, Notes: "Returns a deterministic empty updated-record sync window stub; full org sync tracking is not modeled."},
	...
	{Area: "Messaging", API: "Messaging.renderStoredEmailTemplate(String,String,String,Messaging.AttachmentRetrievalOption)", Status: StatusPartial, Notes: "Uses local stored-template rendering and accepts the attachment option shape; attachment retrieval is not modeled."},
	{Area: "Messaging", API: "Messaging.renderStoredEmailTemplate(String,String,String,Messaging.AttachmentRetrievalOption,Boolean)", Status: StatusPartial, Notes: "Uses local stored-template rendering; updateEmailTemplateUsage is accepted for shape and ignored locally."},
	...
	{Area: "PageReference", API: "PageReference(record)", Status: StatusUnknown, Notes: "Symbol shape is present, but the record constructor runtime path requires constructor handling outside this packet's write scope."},
	...
	{Area: "Schema", API: "Schema.describeSObjects(List<String>)", Status: StatusPartial, Notes: "Object names and SObjectType tokens for local schema."},
	...
	{Area: "Search", API: "Search.query / SOSL FIND", Status: StatusPartial, Notes: "Parses RETURNING clauses and returns deterministic rows from Test.setFixedSearchResults, or empty result groups without external search."},
	{Area: "Search", API: "Search.query(String,AccessLevel)", Status: StatusPartial, Notes: "Uses the deterministic local SOSL model and accepts AccessLevel for shape; external search security is not modeled."},
	{Area: "Search", API: "Search.find", Status: StatusPartial, Notes: "Returns deterministic SearchResult DTOs from Test.setFixedSearchResults; no external search ranking/snippets."},
	{Area: "Search", API: "Search.find(String,AccessLevel)", Status: StatusPartial, Notes: "Uses deterministic fixed search results and accepts AccessLevel for shape; external ranking/snippets are not modeled."},
	{Area: "Search", API: "Search.suggest", Status: StatusPartial, Notes: "Returns an empty deterministic SuggestionResults DTO; no external suggestion service."},
	{Area: "Search", API: "Search.suggest(String,String,Search.SuggestionOption)", Status: StatusPartial, Notes: "Returns an empty deterministic SuggestionResults DTO without external suggestion service calls."},
	{Area: "Search", API: "Search.suggest(String,String,Search.SuggestionOption,AccessLevel)", Status: StatusPartial, Notes: "Accepts AccessLevel for shape and returns the deterministic local SuggestionResults DTO."},
