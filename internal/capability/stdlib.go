...
var stdlibEntries = []StdlibEntry{
	...
	{Area: "Date", API: "Date.addMonths", Status: StatusPartial, Notes: "Local Gregorian arithmetic; exact Salesforce edge-case parity incomplete."},
	{Area: "Date", API: "Date.addYears", Status: StatusPartial, Notes: "Local Gregorian arithmetic; exact Salesforce edge-case parity incomplete."},
	...
	{Area: "Datetime", API: "Datetime.addMonths", Status: StatusPartial, Notes: "UTC-local arithmetic."},
	{Area: "Datetime", API: "Datetime.addSeconds", Status: StatusPartial, Notes: "UTC-local arithmetic."},
	{Area: "Datetime", API: "Datetime.addYears", Status: StatusPartial, Notes: "UTC-local arithmetic."},
