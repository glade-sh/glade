...
var stdlibEntries = []StdlibEntry{
	...
	{Area: "Schema", API: "Schema.describeDataCategoryGroups", Status: StatusPartial, Notes: "Deterministic local data category group describes from org metadata; empty when no metadata is loaded."},
	{Area: "Schema", API: "Schema.describeDataCategoryGroupStructures", Status: StatusPartial, Notes: "Deterministic local data category structures from org metadata; no external category service lookup."},
