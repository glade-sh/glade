...
var stdlibEntries = []StdlibEntry{
	...
	{Area: "Database", API: "Database.getAsyncDeleteResult", Status: StatusSupported, Notes: "Returns a materialized local DeleteResult or deterministic pending placeholder."},
	{Area: "Database", API: "Database.getAsyncSaveResult", Status: StatusSupported, Notes: "Returns a materialized local SaveResult or deterministic pending placeholder."},
	...
	{Area: "Database", API: "Database.getDeleted", Status: StatusSupported, Notes: "Deterministic local empty deleted-record sync window placeholder."},
	...
	{Area: "Database", API: "Database.getUpdated", Status: StatusSupported, Notes: "Deterministic local empty updated-record sync window placeholder."},
