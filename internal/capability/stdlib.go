...
var stdlibEntries = []StdlibEntry{
	...
	{Area: "Database", API: "Database.convertLead", Status: StatusPartial, Notes: "Local no-opportunity lead conversion creates Account and Contact and updates Lead conversion fields; opportunity conversion remains unsupported."},
	...
	{Area: "Database", API: "Database.treeSave", Status: StatusPartial, Notes: "Local insert-only parent plus first-level child relationship save with NestedSaveResult shape; updates and nested child relationships remain unsupported."},
