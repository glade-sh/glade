...
var mvpFeatures = []Feature{
	...
	{ID: "lsp.command", Area: "Developer experience", Name: "oaer lsp core editor features", Status: StatusPartial, Required: true, Notes: "oaer lsp now runs a stdio LSP transport with initialize, diagnostics, incremental text document sync through didOpen/didChange/didClose overlays, document/workspace symbols, hover, and completion. Definition, references, semantic tokens, richer completion, and full check-parity diagnostics remain incomplete."},
