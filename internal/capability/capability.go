...
var mvpFeatures = []Feature{
	...
	{ID: "sobject.apex", Area: "Data runtime", Name: "Apex-integrated SObject construction and field access", Status: StatusPartial, Required: true, Notes: "Apex now supports schema-backed new Account(Name='Acme'), typed field access, dotted assignment, get/put, object-level and field-level addError, hasErrors/getErrors, Id propagation after DML, parent relationship projection access, and VM/storage record conversion. Typed describe APIs and broader SObject system fields remain incomplete."},
