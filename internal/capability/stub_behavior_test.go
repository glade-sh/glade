...
func TestStubBehaviorSeparatesServiceMethodsFromPassiveDTOs(t *testing.T) {
	...
	assertStubBehaviorPrefix(t, entries, "FlexQueue.moveJobToFront(", StubBehaviorUnsupported)
	assertStubBehaviorPrefix(t, entries, "System.pauseJobById(", StubBehaviorUnsupported)
