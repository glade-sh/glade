...
func TestStubBehaviorSeparatesServiceMethodsFromPassiveDTOs(t *testing.T) {
	...
	assertStubBehaviorPrefix(t, entries, "ConnectApi.NextBestAction.executeStrategy(", StubBehaviorUnsupported)
	assertStubBehaviorPrefix(t, entries, "ConnectApi.NextBestAction.setRecommendationReaction(", StubBehaviorUnsupported)
	...
	assertStubBehaviorPrefix(t, entries, "Support.MilestoneTriggerTimeCalculator.calculateMilestoneTriggerTime(", StubBehaviorImplemented)
	...
	assertStubBehaviorPrefix(t, entries, "applauncher.SocialLoginController.getSsoUrl(", StubBehaviorImplemented)
	...
	assertStubBehaviorPrefix(t, entries, "CartExtension.CheckoutPlaceOrder.validate(", StubBehaviorImplemented)
	...
	assertStubBehaviorPrefix(t, entries, "wave.QueryNode.execute(", StubBehaviorImplemented)
	...
	assertStubBehaviorPrefix(t, entries, "YubiAuthForAloha.validateYubiKeyLogin(", StubBehaviorImplemented)
