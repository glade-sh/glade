...
func TestStubBehaviorSeparatesServiceMethodsFromPassiveDTOs(t *testing.T) {
	...
	assertStubBehaviorPrefix(t, entries, "Social.DefaultInboundSocialPostHandler.handleInboundSocialPost(", StubBehaviorUnsupported)
	assertStubBehaviorPrefix(t, entries, "Social.DefaultInboundSocialPostHandler.createPersonaParent(", StubBehaviorUnsupported)
	assertStubBehaviorPrefix(t, entries, "Social.InboundSocialPostHandlerImpl.handleInboundSocialPost(", StubBehaviorUnsupported)
	assertStubBehaviorPrefix(t, entries, "Social.InboundSocialPostHandlerImpl.getPostTagsThatCreateCase()", StubBehaviorUnsupported)
