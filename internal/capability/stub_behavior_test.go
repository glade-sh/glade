...
func TestStubBehaviorSeparatesServiceMethodsFromPassiveDTOs(t *testing.T) {
	...
	assertStubBehaviorPrefix(t, entries, "ConnectApi.CdpQuery.querySql(", StubBehaviorUnsupported)
	...
	assertStubBehaviorPrefix(t, entries, "Messaging.InboundEmailHandler.handleInboundEmail(", StubBehaviorUnsupported)
	...
	assertStubBehaviorPrefix(t, entries, "Slack.BotClient.chatPostMessage(", StubBehaviorUnsupported)
	...
	assertStubBehaviorPrefix(t, entries, "Slack.UserClient.viewsOpen(", StubBehaviorUnsupported)
	...
	assertStubBehaviorPrefix(t, entries, "Slack.EventDispatcher.invoke(", StubBehaviorUnsupported)
