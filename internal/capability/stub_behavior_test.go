...
func TestStubBehaviorSeparatesServiceMethodsFromPassiveDTOs(t *testing.T) {
	...
	assertStubBehaviorPrefix(t, entries, "TxnSecurity.EventCondition.evaluate(", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "workflow.Action.invoke(", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "eventbus.EventPublishSuccessCallback.onSuccess(", StubBehaviorStubNoOp)
	...
	assertStubBehaviorPrefix(t, entries, "OrgInstrumentationOperation.start(OrgMetricPublishTypeEnum)", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "OrgInstrumentationContext.startTime()", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "OrgInstrumentationContext.end()", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "OrgInstrumentationService.propagateContext(HttpRequest)", StubBehaviorStubNoOp)
	...
	assertStubBehaviorPrefix(t, entries, "RichMessaging.ProcessPaymentHandler.processPaymentRequest(", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "Site.UrlRewriter.generateUrlFor(", StubBehaviorStubNoOp)
	...
	assertStubBehaviorPrefix(t, entries, "CartExtension.CartCalculateExecutorMock.calculate(", StubBehaviorStubNoOp)
	...
	assertStubBehaviorPrefix(t, entries, "CartExtension.SplitShipmentServiceMock.arrangeItems(", StubBehaviorStubNoOp)
	...
	assertStubBehaviorPrefix(t, entries, "formulaeval.FormulaInstance.getReferencedFields()", StubBehaviorStubNoOp)
	...
	assertStubBehaviorPrefix(t, entries, "Slack.Message.canBeSeenByUser(", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "Slack.Button.click()", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "Slack.Channel.sendMessage(", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "Slack.Checkbox.toggleValue()", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "Slack.CheckboxGroup.toggleValue(String)", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "Slack.ExternalSelect.query(String)", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "Slack.Modal.submit()", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "Slack.Overflow.clickOption(String)", StubBehaviorStubNoOp)
	...
	assertStubBehaviorPrefix(t, entries, "Slack.ActionDispatcher.allowUnauthenticatedUsers()", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "Slack.EventDispatcher.invoke(", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "Slack.UserProvisioningProvider.importUsers(", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "Slack.UserMappingUrlServiceProvider.generateSlackAuthorizationUrl(", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "Slack.RunnableHandler.run()", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "Canvas.Test.mockRenderContext(", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "eventbus.TestBroker.deliver()", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "eventbus.TestEventService.publishEvent(", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "HttpCalloutMock.respond(", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "WebServiceMock.doInvoke(", StubBehaviorStubNoOp)
	...
	assertStubBehaviorPrefix(t, entries, "SoqlStubProvider.handleSoqlQuery(", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "ExternalServiceTest.sendCallback(", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "TestAsyncHttp.executeHttpRequest(", StubBehaviorStubNoOp)
	assertStubBehaviorExact(t, entries, "Invocable.Action.getDescribe()", StubBehaviorStubNoOp)
	...
	assertStubBehaviorExact(t, entries, "Invocable.Action.Result.clone()", StubBehaviorStubNoOp)
	assertStubBehaviorExact(t, entries, "Invocable.Action.Result.getAction()", StubBehaviorStubNoOp)
	assertStubBehaviorExact(t, entries, "Invocable.Action.Result.getErrors()", StubBehaviorStubNoOp)
	assertStubBehaviorExact(t, entries, "Invocable.Action.Result.getInvocationParameters()", StubBehaviorStubNoOp)
	assertStubBehaviorExact(t, entries, "Invocable.Action.Result.getOutputParameters()", StubBehaviorStubNoOp)
	assertStubBehaviorExact(t, entries, "Invocable.Action.Result.isSuccess()", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "functions.FunctionInvokeMock.respond(", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "functions.MockFunctionInvocationFactory.createSuccessResponse(", StubBehaviorStubNoOp)
	...
	assertStubBehaviorPrefix(t, entries, "SubMgmt.Test.create(", StubBehaviorStubNoOp)
	assertStubBehaviorPrefix(t, entries, "UserProvisioning.ConnectorTestUtil.createConnectedApp(", StubBehaviorStubNoOp)
